...
def main():
    ...
    parser.add_argument("--loss_1", type=float, default=0.1, help="adam second beta value")
    parser.add_argument("--loss_2", type=float, default=0.01, help="adam second beta value")
    parser.add_argument("--loss_3", type=float, default=0.1, help="adam second beta value")
    ...
    # save model args
    args_str = f'{args.model_name}-{args.data_name}-KD-{args.loss_1}-{args.loss_2}-{args.loss_3}'
    ...
    if args.do_eval:
        ...
        for epoch in range(args.epochs):
            trainer.train(epoch)
            # evaluate on HR@20 and NDCG@20, anyone
